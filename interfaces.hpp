...
namespace server_dll { // server.dll
    constexpr std::ptrdiff_t NavGameTest001 = 0xA44E30;
    constexpr std::ptrdiff_t ServerToolsInfo_001 = 0x830200;
    constexpr std::ptrdiff_t Source2GameClients001 = 0x830210;
    constexpr std::ptrdiff_t Source2GameEntities001 = 0x830220;
    constexpr std::ptrdiff_t Source2Server001 = 0x830230;
